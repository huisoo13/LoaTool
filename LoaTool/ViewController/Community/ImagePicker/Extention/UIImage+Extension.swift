...
extension UIImage {
    ...
    public class func gifImageWithURL(_ gifUrl:String) -> UIImage? {
        guard let bundleURL: URL = URL(string: gifUrl) else {
            debug("image named \"\(gifUrl)\" doesn't exist")
            return nil
        }
        
        guard let imageData = try? Data(contentsOf: bundleURL) else {
            debug("image named \"\(gifUrl)\" into NSData")
            return nil
        }
    ...
    public class func gifImageWithName(_ name: String) -> UIImage? {
        guard let bundleURL = Bundle.main
            ...
            debug("SwiftGif: This image named \"\(name)\" does not exist")
            return nil
        }
        guard let imageData = try? Data(contentsOf: bundleURL) else {
            debug("SwiftGif: Cannot turn image named \"\(name)\" into NSData")
            return nil
        }
